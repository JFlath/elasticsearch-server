 ...
 *
 */
public class RestGetIndicesAliasesAction extends BaseRestHandler<ClusterAdminClient> {

    @Inject
    public RestGetIndicesAliasesAction(Settings settings, ClusterAdminClient client, RestController controller) {
