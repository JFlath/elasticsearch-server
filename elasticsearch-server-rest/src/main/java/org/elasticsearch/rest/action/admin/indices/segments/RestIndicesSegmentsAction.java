...
/**
 */
public class RestIndicesSegmentsAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestIndicesSegmentsAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.segments(indicesSegmentsRequest, new ActionListener<IndicesSegmentResponse>() {
            @Override
