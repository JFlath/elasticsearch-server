 ...
 *
 */
public class RestPercolateAction extends BaseRestHandler<IngestClient> {

    @Inject
    public RestPercolateAction(Settings settings, IngestClient client, RestController controller) {
