...
public class RestMultiGetAction extends BaseRestHandler<IngestClient> {

    @Inject
    public RestMultiGetAction(Settings settings, IngestClient client, RestController controller) {
