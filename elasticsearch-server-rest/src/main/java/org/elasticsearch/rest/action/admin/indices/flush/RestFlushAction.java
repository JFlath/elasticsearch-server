 ...
 *
 */
public class RestFlushAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestFlushAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.flush(flushRequest, new ActionListener<FlushResponse>() {
            @Override
