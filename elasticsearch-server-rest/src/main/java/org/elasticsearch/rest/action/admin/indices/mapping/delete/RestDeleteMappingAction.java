...
import static org.elasticsearch.client.AdminRequests.deleteMappingRequest;
 ...
 *
 */
public class RestDeleteMappingAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestDeleteMappingAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.deleteMapping(deleteMappingRequest, new ActionListener<DeleteMappingResponse>() {
            @Override
