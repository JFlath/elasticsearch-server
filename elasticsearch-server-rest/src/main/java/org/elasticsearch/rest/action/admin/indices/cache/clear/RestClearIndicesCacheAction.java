 ...
 *
 */
public class RestClearIndicesCacheAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestClearIndicesCacheAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.clearCache(clearIndicesCacheRequest, new ActionListener<ClearIndicesCacheResponse>() {
            @Override
