 ...
 *
 */
public class RestIndicesStatusAction extends BaseRestHandler<IndicesAdminClient> {

    private final SettingsFilter settingsFilter;

    @Inject
    public RestIndicesStatusAction(Settings settings, IndicesAdminClient client, RestController controller,
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.status(indicesStatusRequest, new ActionListener<IndicesStatusResponse>() {
            @Override
