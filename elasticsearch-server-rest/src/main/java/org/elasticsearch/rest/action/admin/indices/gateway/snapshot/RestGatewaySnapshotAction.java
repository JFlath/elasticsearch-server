 ...
 *
 */
public class RestGatewaySnapshotAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestGatewaySnapshotAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.gatewaySnapshot(gatewaySnapshotRequest, new ActionListener<GatewaySnapshotResponse>() {
            @Override
