 ...
 *
 */
public class RestPutIndexTemplateAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestPutIndexTemplateAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.putTemplate(putRequest, new ActionListener<PutIndexTemplateResponse>() {
            @Override
