...
import static org.elasticsearch.client.SearchRequests.moreLikeThisRequest;
 ...
 *
 */
public class RestMoreLikeThisAction extends BaseRestHandler<SearchClient> {

    @Inject
    public RestMoreLikeThisAction(Settings settings, SearchClient client, RestController controller) {
