 ...
 * </pre>
 */
public class RestBulkAction extends BaseRestHandler<IngestClient> {

    @Inject
    public RestBulkAction(Settings settings, IngestClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        BulkRequest bulkRequest = IngestRequests.bulkRequest();
