...
public class RestClusterRerouteAction extends BaseRestHandler<ClusterAdminClient> {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        final ClusterRerouteRequest clusterRerouteRequest = AdminRequests.clusterRerouteRequest();
        ...
        client.reroute(clusterRerouteRequest, new ActionListener<ClusterRerouteResponse>() {
            @Override
