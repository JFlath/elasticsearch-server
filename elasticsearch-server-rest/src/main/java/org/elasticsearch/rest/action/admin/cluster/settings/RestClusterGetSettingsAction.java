...
/**
 */
public class RestClusterGetSettingsAction extends BaseRestHandler<ClusterAdminClient> {

    @Inject
    public RestClusterGetSettingsAction(Settings settings, ClusterAdminClient client, RestController controller) {
