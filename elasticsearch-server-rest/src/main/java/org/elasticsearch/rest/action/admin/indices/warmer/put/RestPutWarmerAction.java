...
/**
 */
public class RestPutWarmerAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestPutWarmerAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.putWarmer(putWarmerRequest, new ActionListener<PutWarmerResponse>() {
            @Override
