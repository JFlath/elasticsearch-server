 ...
 *
 */
public class RestAnalyzeAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestAnalyzeAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.analyze(analyzeRequest, new ActionListener<AnalyzeResponse>() {
            @Override
