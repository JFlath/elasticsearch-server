 ...
 */
public class RestExplainAction extends BaseRestHandler<SearchClient> {

    @Inject
    public RestExplainAction(Settings settings, SearchClient client, RestController controller) {
