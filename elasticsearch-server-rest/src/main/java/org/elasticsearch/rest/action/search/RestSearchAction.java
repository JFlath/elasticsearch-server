 ...
 *
 */
public class RestSearchAction extends BaseRestHandler<SearchClient> {

    @Inject
    public RestSearchAction(Settings settings, SearchClient client, RestController controller) {
