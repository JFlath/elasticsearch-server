 ...
 *
 */
public class RestDeleteAction extends BaseRestHandler<IngestClient> {

    @Inject
    public RestDeleteAction(Settings settings, IngestClient client, RestController controller) {
