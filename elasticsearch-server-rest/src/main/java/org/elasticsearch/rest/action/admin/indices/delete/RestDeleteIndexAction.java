 ...
 *
 */
public class RestDeleteIndexAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestDeleteIndexAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.delete(deleteIndexRequest, new ActionListener<DeleteIndexResponse>() {
            @Override
