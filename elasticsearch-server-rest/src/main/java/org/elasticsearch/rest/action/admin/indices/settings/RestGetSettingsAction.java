...
public class RestGetSettingsAction extends BaseRestHandler<ClusterAdminClient> {

    private final SettingsFilter settingsFilter;

    @Inject
    public RestGetSettingsAction(Settings settings, ClusterAdminClient client, RestController controller, SettingsFilter settingsFilter) {
