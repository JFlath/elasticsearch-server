 ...
 *
 */
public class RestNodesRestartAction extends BaseRestHandler<ClusterAdminClient> {

    @Inject
    public RestNodesRestartAction(Settings settings, ClusterAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.nodesRestart(nodesRestartRequest, new ActionListener<NodesRestartResponse>() {
            @Override
