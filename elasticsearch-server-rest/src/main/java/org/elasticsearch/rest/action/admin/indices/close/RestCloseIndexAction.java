 ...
 *
 */
public class RestCloseIndexAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestCloseIndexAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.close(closeIndexRequest, new ActionListener<CloseIndexResponse>() {
            @Override
