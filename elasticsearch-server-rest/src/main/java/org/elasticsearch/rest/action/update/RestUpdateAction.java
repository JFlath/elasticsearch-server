...
/**
 */
public class RestUpdateAction extends BaseRestHandler<IngestClient> {

    @Inject
    public RestUpdateAction(Settings settings, IngestClient client, RestController controller) {
