 ...
 */
public class RestTypesExistsAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestTypesExistsAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.typesExists(typesExistsRequest, new ActionListener<TypesExistsResponse>() {
            @Override
