 ...
 *
 */
public class RestNodesStatsAction extends BaseRestHandler<ClusterAdminClient> {

    @Inject
    public RestNodesStatsAction(Settings settings, ClusterAdminClient client, RestController controller) {
