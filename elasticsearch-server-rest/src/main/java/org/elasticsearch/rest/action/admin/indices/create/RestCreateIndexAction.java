 ...
 *
 */
public class RestCreateIndexAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestCreateIndexAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.create(createIndexRequest, new ActionListener<CreateIndexResponse>() {
            @Override
