 ...
 *
 */
public class RestRefreshAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestRefreshAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.refresh(refreshRequest, new ActionListener<RefreshResponse>() {
            @Override
