 ...
 *
 */
public class RestMainAction extends BaseRestHandler<ClusterAdminClient> {

    @Inject
    public RestMainAction(Settings settings, ClusterAdminClient client, RestController controller) {
