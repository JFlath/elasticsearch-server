 ...
 *
 */
public class RestDeleteIndexTemplateAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestDeleteIndexTemplateAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.deleteTemplate(deleteIndexTemplateRequest, new ActionListener<DeleteIndexTemplateResponse>() {
            @Override
