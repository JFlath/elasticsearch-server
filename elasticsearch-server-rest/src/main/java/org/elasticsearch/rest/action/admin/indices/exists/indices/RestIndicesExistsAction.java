 ...
 *
 */
public class RestIndicesExistsAction extends BaseRestHandler<IndicesAdminClient> {

    private final SettingsFilter settingsFilter;

    @Inject
    public RestIndicesExistsAction(Settings settings, IndicesAdminClient client, RestController controller,
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.exists(indicesExistsRequest, new ActionListener<IndicesExistsResponse>() {
            @Override
