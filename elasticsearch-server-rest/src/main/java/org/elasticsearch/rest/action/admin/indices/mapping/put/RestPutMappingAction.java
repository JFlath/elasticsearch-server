...
import static org.elasticsearch.client.AdminRequests.putMappingRequest;
 ...
 *
 */
public class RestPutMappingAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestPutMappingAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.putMapping(putMappingRequest, new ActionListener<PutMappingResponse>() {
            @Override
