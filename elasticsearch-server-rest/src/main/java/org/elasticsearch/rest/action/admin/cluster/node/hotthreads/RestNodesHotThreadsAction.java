...
/**
 */
public class RestNodesHotThreadsAction extends BaseRestHandler<ClusterAdminClient> {

    @Inject
    public RestNodesHotThreadsAction(Settings settings, ClusterAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.nodesHotThreads(nodesHotThreadsRequest, new ActionListener<NodesHotThreadsResponse>() {
            @Override
