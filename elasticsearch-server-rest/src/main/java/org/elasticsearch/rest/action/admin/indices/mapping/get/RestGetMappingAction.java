 ...
 *
 */
public class RestGetMappingAction extends BaseRestHandler<ClusterAdminClient> {

    @Inject
    public RestGetMappingAction(Settings settings, ClusterAdminClient client, RestController controller) {
