...
/**
 */
public class RestIndicesStatsAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestIndicesStatsAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.stats(indicesStatsRequest, new ActionListener<IndicesStats>() {
            @Override
