...
/**
 */
public class RestMultiSearchAction extends BaseRestHandler<SearchClient> {

    @Inject
    public RestMultiSearchAction(Settings settings, SearchClient client, RestController controller) {
