 ...
 *
 */
public class RestIndexAction extends BaseRestHandler<IngestClient> {

    @Inject
    public RestIndexAction(Settings settings, IngestClient client, RestController controller) {
