 ...
 *
 */
public class RestValidateQueryAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestValidateQueryAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.validateQuery(validateQueryRequest, new ActionListener<ValidateQueryResponse>() {
            @Override
