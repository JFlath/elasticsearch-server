 ...
 *
 */
public class RestOptimizeAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestOptimizeAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.optimize(optimizeRequest, new ActionListener<OptimizeResponse>() {
            @Override
