 ...
 *
 */
public class RestNodesShutdownAction extends BaseRestHandler<ClusterAdminClient> {

    @Inject
    public RestNodesShutdownAction(Settings settings, ClusterAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.nodesShutdown(nodesShutdownRequest, new ActionListener<NodesShutdownResponse>() {
            @Override
