 ...
 *
 */
public class RestIndicesAliasesAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestIndicesAliasesAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.aliases(indicesAliasesRequest, new ActionListener<IndicesAliasesResponse>() {
            @Override
