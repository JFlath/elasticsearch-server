 ...
 *
 */
public class RestCountAction extends BaseRestHandler<SearchClient> {

    @Inject
    public RestCountAction(Settings settings, SearchClient client, RestController controller) {
