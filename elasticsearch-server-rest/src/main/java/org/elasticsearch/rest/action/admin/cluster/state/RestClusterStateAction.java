 ...
 *
 */
public class RestClusterStateAction extends BaseRestHandler<ClusterAdminClient> {

    private final SettingsFilter settingsFilter;

    @Inject
    public RestClusterStateAction(Settings settings, ClusterAdminClient client, RestController controller,
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        final ClusterStateRequest clusterStateRequest = AdminRequests.clusterStateRequest();
