...
/**
 */
public class RestClusterUpdateSettingsAction extends BaseRestHandler<ClusterAdminClient> {

    @Inject
    public RestClusterUpdateSettingsAction(Settings settings, ClusterAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        final ClusterUpdateSettingsRequest clusterUpdateSettingsRequest = AdminRequests.clusterUpdateSettingsRequest();
        ...
        client.updateSettings(clusterUpdateSettingsRequest, new ActionListener<ClusterUpdateSettingsResponse>() {
            @Override
