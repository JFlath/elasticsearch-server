 ...
 *
 */
public class RestSearchScrollAction extends BaseRestHandler<SearchClient> {

    @Inject
    public RestSearchScrollAction(Settings settings, SearchClient client, RestController controller) {
