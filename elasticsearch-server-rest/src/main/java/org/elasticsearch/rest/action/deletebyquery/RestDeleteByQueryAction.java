 ...
 *
 */
public class RestDeleteByQueryAction extends BaseRestHandler<SearchClient> {

    @Inject
    public RestDeleteByQueryAction(Settings settings, SearchClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        try {
            ...
            deleteByQueryRequest.timeout(request.paramAsTime("timeout", ShardReplicationOperationRequest.DEFAULT_TIMEOUT));
