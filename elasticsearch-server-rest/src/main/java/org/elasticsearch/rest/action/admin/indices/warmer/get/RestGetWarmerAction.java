 ...
 *
 */
public class RestGetWarmerAction extends BaseRestHandler<ClusterAdminClient> {

    @Inject
    public RestGetWarmerAction(Settings settings, ClusterAdminClient client, RestController controller) {
