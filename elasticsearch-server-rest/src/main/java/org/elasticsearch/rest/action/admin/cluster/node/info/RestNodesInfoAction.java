 ...
 *
 */
public class RestNodesInfoAction extends BaseRestHandler<ClusterAdminClient> {

    private final SettingsFilter settingsFilter;

    @Inject
    public RestNodesInfoAction(Settings settings, ClusterAdminClient client, RestController controller,
    ...
    void executeNodeRequest(final RestRequest request, final RestChannel channel, NodesInfoRequest nodesInfoRequest) {
        ...
        client.nodesInfo(nodesInfoRequest, new ActionListener<NodesInfoResponse>() {
            @Override
