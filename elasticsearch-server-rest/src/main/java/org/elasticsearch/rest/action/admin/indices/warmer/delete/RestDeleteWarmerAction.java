...
/**
 */
public class RestDeleteWarmerAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestDeleteWarmerAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.deleteWarmer(deleteWarmerRequest, new ActionListener<DeleteWarmerResponse>() {
            @Override
