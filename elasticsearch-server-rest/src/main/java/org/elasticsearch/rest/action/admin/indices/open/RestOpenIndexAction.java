 ...
 *
 */
public class RestOpenIndexAction extends BaseRestHandler<IndicesAdminClient> {

    @Inject
    public RestOpenIndexAction(Settings settings, IndicesAdminClient client, RestController controller) {
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        ...
        client.open(openIndexRequest, new ActionListener<OpenIndexResponse>() {
            @Override
