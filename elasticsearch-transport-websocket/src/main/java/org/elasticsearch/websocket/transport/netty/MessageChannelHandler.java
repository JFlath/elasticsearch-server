...
import org.elasticsearch.websocket.common.compress.NettyCompressor;
import org.elasticsearch.websocket.common.compress.NettyCompressorFactory;
import org.elasticsearch.common.io.ThrowableObjectInputStream;
import org.elasticsearch.websocket.common.io.stream.NettyCachedStreamInput;
...
public class MessageChannelHandler extends SimpleChannelUpstreamHandler {
    ...
    public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) throws Exception {
        ...
        if (TransportStatus.isCompress(status) && hasMessageBytesToRead && buffer.readable()) {
            NettyCompressor compressor = NettyCompressorFactory.compressor(buffer);
            if (compressor == null) {
            ...
            wrappedStream = NettyCachedStreamInput.cachedHandlesCompressed(compressor, streamIn);
        } else {
            wrappedStream = NettyCachedStreamInput.cachedHandles(streamIn);
        }
