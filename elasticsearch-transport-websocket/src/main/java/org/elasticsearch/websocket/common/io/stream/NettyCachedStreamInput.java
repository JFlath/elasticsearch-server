 ...
 *
 */
public class NettyCachedStreamInput {
    ...
    public static StreamInput compressed(NettyCompressor compressor, StreamInput in) throws IOException {
    ...
    public static HandlesStreamInput cachedHandlesCompressed(NettyCompressor compressor, StreamInput in) throws IOException {
