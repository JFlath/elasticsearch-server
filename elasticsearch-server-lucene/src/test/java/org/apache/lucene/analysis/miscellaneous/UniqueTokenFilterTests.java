 ...
 */
@Test
public class UniqueTokenFilterTests extends Assert {
    ...
    public void simpleTest() throws IOException {
        ...
        assertEquals(termAttribute.toString(), "this");

        assertTrue(test.incrementToken());
        assertEquals(termAttribute.toString(), "test");

        assertTrue(test.incrementToken());
        assertEquals(termAttribute.toString(), "with");
