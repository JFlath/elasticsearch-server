...
public class MappingCharFilterFactory extends AbstractCharFilterFactory {
    ...
    @Inject
    public MappingCharFilterFactory(Index index, @IndexSettings Settings indexSettings, ClientEnvironment env, @Assisted String name, @Assisted Settings settings) {
