...
public class WordDelimiterTokenFilterFactory extends AbstractTokenFilterFactory {
    ...
    @Inject
    public WordDelimiterTokenFilterFactory(Index index, @IndexSettings Settings indexSettings, ClientEnvironment env, @Assisted String name, @Assisted Settings settings) {
