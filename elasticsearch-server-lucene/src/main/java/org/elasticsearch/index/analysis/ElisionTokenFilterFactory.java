...
public class ElisionTokenFilterFactory extends AbstractTokenFilterFactory {
    ...
    @Inject
    public ElisionTokenFilterFactory(Index index, @IndexSettings Settings indexSettings, ClientEnvironment env, @Assisted String name, @Assisted Settings settings) {
