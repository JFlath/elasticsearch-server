 ...
 *
 */
public class InternalTransportIngestClient extends AbstractIngestClient implements InternalGenericClient {
    ...
    @Inject
    public InternalTransportIngestClient(Settings settings, TransportService transportService,
