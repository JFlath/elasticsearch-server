...
public final class InternalNode implements Node {
    ...
    public InternalNode(Settings pSettings, boolean loadConfigSettings) throws ElasticSearchException {
        ...
        ingestClient = injector.getInstance(IngestClient.class);
...
//        }
    ...
    public void close() {
        ...
        stopWatch.stop().start("ingestclient");
        injector.getInstance(IngestClient.class).close();
        stopWatch.stop().start("searchclient");
        injector.getInstance(SearchClient.class).close();
        stopWatch.stop().start("clusteradminclient");
        injector.getInstance(ClusterAdminClient.class).close();
        stopWatch.stop().start("indicesadminclient");
        injector.getInstance(IndicesAdminClient.class).close();
