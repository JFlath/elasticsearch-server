...
import org.elasticsearch.action.admin.cluster.node.info.ServerNodeInfo;
...
public class NodeService extends AbstractComponent {
    ...
    public ServerNodeInfo info() {
        return new ServerNodeInfo(hostname, clusterService.state().nodes().localNode(), serviceAttributes,
                settings,
    ...
    public ServerNodeInfo info(boolean settings, boolean os, boolean process, boolean jvm, boolean threadPool, boolean network, boolean transport, boolean http) {
        return new ServerNodeInfo(hostname, clusterService.state().nodes().localNode(), serviceAttributes,
