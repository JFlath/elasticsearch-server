...
/**
 */
public class RestClusterRerouteAction extends BaseRestHandler<ClusterAdminClient> {

    private final SettingsFilter settingsFilter;

    @Inject
    public RestClusterRerouteAction(Settings settings, ClusterAdminClient client, RestController controller,
    ...
    public void handleRequest(final RestRequest request, final RestChannel channel) {
        final ClusterRerouteRequest clusterRerouteRequest = ServerAdminRequests.clusterRerouteRequest();
        ...
        ((ServerClusterAdminClient)client).reroute(clusterRerouteRequest, new ActionListener<ClusterRerouteResponse>() {
            @Override
