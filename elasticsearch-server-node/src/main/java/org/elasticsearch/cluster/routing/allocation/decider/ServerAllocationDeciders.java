 ...
 */
public class ServerAllocationDeciders extends AllocationDeciders {

    private final Settings settings;
    
    private final AllocationDecider[] allocations;

    public ServerAllocationDeciders(Settings settings, NodeSettingsService nodeSettingsService) {
    ...
    @Inject
    public ServerAllocationDeciders(Settings settings, Set<AllocationDecider> allocations) {
