 ...
 *
 */
public class ServerMappingMetaData extends MappingMetaData {

    public ServerMappingMetaData(DocumentMapper docMapper) {
        super(docMapper.type(), docMapper.mappingSource());
